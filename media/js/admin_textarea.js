tinyMCE.init({		
        ...
        language:"zh",
        media_flv_players : [ {url: "/resources/flvplayer.swf", helpurl: "/resources/flvplayer-documentation.html", flvurl_param: "flvToPlay", previewimage_param: "startImage", autostart_param: "autoStart", default_params: "hiddenGui=true&smoothVideo=true" } ],
		// Theme options
		...
		theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,media,filemanager,cleanup,|,insertdate,inserttime,preview,|,forecolor,backcolor,|,insertcode,code",
